...
public class SessionFilter extends OncePerRequestFilter {
    ...
    private final MyUserDetailsService currentUserService;

    @Autowired
    public SessionFilter(final SessionRegistry sessionRegistry,
                         final MyUserDetailsService currentUserService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        final MyOwnUserDetails currentUser = currentUserService.loadUserByUsername(username);
